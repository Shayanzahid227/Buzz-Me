...
class AppAssets {
  ...
  String discover1 = "$iconsAssets/discover1.png";
  String discover2 = "$iconsAssets/discover2.png";
  String Favorite1 = "$iconsAssets/Favorite1.png";
  String Favorite2 = "$iconsAssets/Favorite2.png";
  String Message1 = "$iconsAssets/Message1.png";
  String Message2 = "$iconsAssets/Message2.png";
  String nearby1 = "$iconsAssets/nearby1.png";
